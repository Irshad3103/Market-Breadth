...
function App() {
  ...
  const getBackgroundClass = () => {
    ...
    switch (marketBreadth.marketHealth) {
      ...
      case 'very strong':
        return 'bg-gradient-to-br from-green-800 via-slate-900 to-emerald-800';
      case 'strong':
        return 'bg-gradient-to-br from-emerald-800 via-slate-900 to-green-800';
      case 'neutral':
        return 'bg-gradient-to-br from-amber-900 via-slate-900 to-orange-900';
      case 'weak':
        return 'bg-gradient-to-br from-orange-900 via-slate-900 to-red-800';
      case 'bearish':
